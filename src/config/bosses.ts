...
export const BOSSES: Record<string, BossDef> = {
  ...
  golem: {
    ...
    hp: 760, scale: 0.82, contactDamage: 18, auraColor: 0xff6a1f, level: 35,
    phases: [
  ...
  roi: {
    ...
    hp: 6900, scale: 0.82, contactDamage: 20, auraColor: 0xb26bff, level: 50,
    phases: [
  ...
  leviathan: {
    ...
    hp: 3733, scale: 0.82, contactDamage: 22, auraColor: 0x7fdcff, level: 70,
    phases: [
  ...
  reflet: {
    ...
    hp: 6300, scale: 0.82, contactDamage: 26, auraColor: 0xd05aff, level: 99,
    phases: [
      { hpFrac: 1.0, speed: 150, moves: [
