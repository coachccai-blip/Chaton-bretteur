...
export const BOSSES: Record<string, BossDef> = {
  ...
  crapaudroi: {
    ...
    hp: 500, scale: 0.82, contactDamage: 16, auraColor: 0x9fe04a, level: 20,
    phases: [
  ...
  golem: {
    ...
    hp: 800, scale: 0.82, contactDamage: 18, auraColor: 0xff6a1f, level: 35,
    phases: [
  ...
  roi: {
    ...
    hp: 1200, scale: 0.82, contactDamage: 20, auraColor: 0xb26bff, level: 50,
    phases: [
  ...
  leviathan: {
    ...
    hp: 3000, scale: 0.82, contactDamage: 22, auraColor: 0x7fdcff, level: 70,
    phases: [
