...
export const BOSSES: Record<string, BossDef> = {
  ...
  golem: {
    ...
    hp: 1520, scale: 0.82, contactDamage: 18, auraColor: 0xff6a1f, level: 35,
    phases: [
  ...
  roi: {
    ...
    hp: 3450, scale: 0.82, contactDamage: 20, auraColor: 0xb26bff, level: 50,
    phases: [
  ...
  leviathan: {
    ...
    hp: 11200, scale: 0.82, contactDamage: 22, auraColor: 0x7fdcff, level: 70,
    phases: [
  ...
  rapace: {
    ...
    hp: 17500, scale: 0.82, contactDamage: 24, auraColor: 0xb0c8ff, level: 85,
    phases: [
  ...
  reflet: {
    ...
    hp: 25200, scale: 0.82, contactDamage: 26, auraColor: 0xd05aff, level: 99,
    phases: [
      { hpFrac: 1.0, speed: 150, moves: [
